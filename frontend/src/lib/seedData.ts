...
export const PROCESS_STEPS = [
  { cls: 'active' as const, icon: '◌', text: 'Ingesting Sprint Review transcript…' },
  { cls: 'done'   as const, icon: '✓', text: 'Transcript split · 4 turns detected',    tag: '4' },
  { cls: 'active' as const, icon: '◌', text: 'Resolving speakers against existing graph…' },
  { cls: 'done'   as const, icon: '✓', text: 'Speakers matched · 4 known persons',      tag: '4' },
  { cls: 'active' as const, icon: '◌', text: 'Extracting entities · claude-3-5-sonnet…' },
  { cls: 'done'   as const, icon: '✓', text: 'Entities extracted · confidence 0.94',    tag: '0.94' },
  { cls: 'active' as const, icon: '◌', text: 'Writing to SurrealDB…' },
  { cls: 'done'   as const, icon: '✓', text: 'Graph updated · 6 nodes · 8 edges',       tag: '+6/+8' },
  { cls: 'warn'   as const, icon: '⚠', text: 'Contradiction detected · d9 vs d3',       tag: 'HIGH' },
  { cls: 'done'   as const, icon: '✓', text: 'Checkpoint saved · sprint-review-w12' },
]
